...
public class UnionandISLinkedList {
	...
	// linked lists
	    ...
	    {
	    	UnionandISLinkedList llist1 = new UnionandISLinkedList();
	    	UnionandISLinkedList llist2 = new UnionandISLinkedList();
	    	UnionandISLinkedList unin= new UnionandISLinkedList();
	    	UnionandISLinkedList intersecn = new UnionandISLinkedList();
